...
from app.services.tenant_plan_service import FEATURE_CAPABILITY_KEYS, get_plan_capabilities, get_tenant_capabilities
...
def get_default_feature_runtime() -> dict[str, bool]:
    return {feature_key: False for feature_key in RUNTIME_FEATURE_KEYS}
...
def is_tenant_feature_enabled(
    ...
    if normalized_key not in RUNTIME_FEATURE_KEYS:
        return False
