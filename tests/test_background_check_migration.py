...
def test_single_head_is_current():
    # Head avanca conforme novas migrations entram. Hoje: 0042 (backfill encrypt
    # CPF/RG, encadeada na 0041→0040). O importante e haver UM unico head (sem bifurcacao).
    script = _script()
