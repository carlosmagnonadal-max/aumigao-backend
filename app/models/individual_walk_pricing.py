...
class TenantIndividualWalkPricing(Base):
    ...
    price_30: Mapped[float] = mapped_column(Money, nullable=False, default=36.90)
    price_45: Mapped[float] = mapped_column(Money, nullable=False, default=49.90)
    price_60: Mapped[float] = mapped_column(Money, nullable=False, default=62.90)
