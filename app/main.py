...
app.include_router(walks.api_router)
...
app.include_router(tenant_units_admin.admin_router)
app.include_router(tenant_units_admin.admin_api_router)
...
# S2 — Capacitação do passeador (manual + quiz + guia rápido + regras da cidade).
app.include_router(walker_training.router)
app.include_router(walker_training.api_router)
app.include_router(walker_training.admin_router)
app.include_router(walker_training.api_admin_router)
...
app.include_router(admin_legal_documents.router)
...
app.include_router(product_highlights.api_router)
app.include_router(product_highlights.tutor_router)
app.include_router(product_highlights.api_tutor_router)
app.include_router(walker_indications.router)
app.include_router(walker_indications.api_router)
app.include_router(walker_indications.public_router)
app.include_router(walker_indications.api_public_router)
